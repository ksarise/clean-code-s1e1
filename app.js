...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = "tasks__input task__input_check";
    editInput.type="text";
    editInput.className="tasks__input task__input_text";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="tasks__button task__button_edit";

    deleteButton.className="tasks__button task__button_delete";
